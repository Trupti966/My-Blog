...
//        UserDetails user = User.builder().username("trupti").password(getEncodedPassword().encode("Testing")).roles("USER").build();
...
//    }
    ...
    protected void configure(AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception{
        authenticationManagerBuilder.userDetailsService(customUserDetailsService).passwordEncoder(getEncodedPassword());
    }
